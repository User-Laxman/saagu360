...
export default function DashboardScreen() {
  ...
  useEffect(() => {
    (async () => {
      try {
        setLoading(true);
        let city = 'Hyderabad', lat: number | null = null, lon: number | null = null;
        ...
        if (status === 'granted') {
          try {
            ...
            if (loc) {
              ...
              if (geo.length > 0) {
                city = geo[0].city || geo[0].subregion || 'Hyderabad';
                console.log("📍 Successfully unlocked Location:", city);
              }
            }
          } catch (_) {}
        }
        ...
        <View style={styles.content}>
          ...
          {cropChips.length > 0 && (
            <>
              <View style={styles.sectionRow}>
                ...
                <TouchableOpacity onPress={() => router.push('/market-prices' as any)}>
          ...
          <View style={styles.featGrid}>
            <TouchableOpacity
              ...
              onPress={() => router.push('/disease-scan' as any)}
              activeOpacity={0.8}
            >
            ...
            <TouchableOpacity
              ...
              onPress={() => router.push('/weather-irrigation' as any)}
              activeOpacity={0.8}
            >
            ...
            <TouchableOpacity
              style={styles.featCard}
              onPress={() => router.push('/market-prices' as any)}
              activeOpacity={0.8}
            >
              <View style={styles.liveBadge}><Text style={styles.liveBadgeText}>LIVE</Text></View>
              <Text style={styles.featEmoji}>📈</Text>
          ...
          <View style={styles.activityCard}>
            ...
            <View style={{ flex: 1 }}>
              <Text style={styles.actTitle}>Dashboard synced</Text>
              <Text style={styles.actSub}>Just now · {weatherData?.city || 'Location'}</Text>
            </View>
...
const styles = StyleSheet.create({
  ...
  badgeGreen:   { backgroundColor: COLORS.green100, paddingHorizontal: 10, paddingVertical: 6, borderRadius: 16 },
